...
export const MEDIAVALET_LOGIN_URL = `https://login.mediavalet.com/connect/authorize?client_id=${MEDIAVALET_CLIENT_ID}&response_type=code&scope=openid%20api&redirect_uri=http://localhost:3000&state=state-296bc9a0`